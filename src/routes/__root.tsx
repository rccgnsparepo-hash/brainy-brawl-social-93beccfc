...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "MindSprint Social" },
      { property: "og:description", content: "Twitter meets brain duels for students. Compete, post, and climb the school leaderboards." },
